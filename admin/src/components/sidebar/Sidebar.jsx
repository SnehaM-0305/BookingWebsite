  ...
  return (
    <div className='sidebar'>
        ...
        <div className="center">
            ...
            <li><CategoryIcon className='icon'/><Link to='/products' style={{textDecoration:"none"}}><span>Products</span></Link></li>
            <li><BookmarkBorderTwoToneIcon className='icon'/><span>Orders</span></li>
